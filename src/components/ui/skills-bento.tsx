...
import { 
  SiPython, SiCplusplus, SiMysql, SiHtml5, SiJavascript, SiReact, SiNextdotjs, SiNodedotjs, SiExpress, SiMongodb, SiPostgresql, SiTailwindcss, SiSelenium, SiPostman, SiGithub, SiJira, SiVercel, SiFirebase
} from 'react-icons/si';
import { TbBrandOpenai } from 'react-icons/tb';
import { FaCogs, FaCode, FaDatabase, FaServer, FaCheckSquare, FaComments, FaUsers, FaFileExcel, FaVial } from 'react-icons/fa';
...
export const skillData: Record<string, { icon: React.ReactNode, color: string }> = {
  ...
  "Stored Procedures": { icon: <FaCogs />, color: "#A0A0A0" },
  "Triggers": { icon: <FaCogs />, color: "#FF6D5A" },
  "Indexing & Schema Design": { icon: <FaDatabase />, color: "#00FF88" },
  "Selenium": { icon: <SiSelenium />, color: "#43B02A" },
  "Playwright": { icon: <FaVial />, color: "#2EAD33" },
  "Black Box": { icon: <FaCheckSquare />, color: "#A0A0A0" },
  "White Box": { icon: <FaCheckSquare />, color: "#ffffff" },
  "Unit Testing": { icon: <FaVial />, color: "#E34F26" },
  "Functional Testing": { icon: <FaCheckSquare />, color: "#009688" },
  ...
  "AI Integration": { icon: <TbBrandOpenai />, color: "#10A37F" },
  "Communication": { icon: <FaComments />, color: "#4285F4" },
  "Customer Acquisition": { icon: <FaUsers />, color: "#FF3366" }
};
