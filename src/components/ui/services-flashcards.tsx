...
const flashcards = [
  {
    ...
    description: "Building and shipping production websites and web apps for clients with Next.js and the MERN stack — from business sites to full e-commerce platforms.",
    highlights: [
      { title: "Client Websites", desc: "Law firms, academies & clinics — live on Next.js" },
      { title: "E-Commerce Platforms", desc: "Cart, checkout & admin panels built on MERN" },
      { title: "Responsive & SEO-Ready", desc: "Fast, mobile-first UIs deployed on Vercel" }
    ],
    tags: ["Next.js", "React", "Node.js", "Express", "Tailwind CSS", "Vercel"]
  },
  {
    id: "database",
    num: "02",
    ...
    description: "Designing schemas and writing complex queries, stored procedures, and triggers — with performance tuning through indexing across SQL, MySQL, PostgreSQL, and MongoDB.",
    highlights: [
      { title: "Schema Design", desc: "Normalized, scalable relational & NoSQL models" },
      { title: "Stored Procedures & Triggers", desc: "Complex server-side logic & automation" },
      { title: "Performance Tuning", desc: "Indexing & query optimization for speed" }
    ],
    tags: ["SQL", "MySQL", "PostgreSQL", "MongoDB", "Indexing", "Query Optimization"]
  },
  {
    id: "testing",
    num: "03",
    ...
    description: "Ensuring applications ship reliably through black box, white box, unit, and functional testing — automated with Selenium, Playwright, and Postman.",
    highlights: [
      { title: "Automated E2E Testing", desc: "Selenium & Playwright browser automation suites" },
      { title: "API Testing", desc: "Postman collections validating REST integrations" },
      { title: "CRUD & Data Integrity", desc: "Functional testing that guarantees reliability" }
    ],
    tags: ["Selenium", "Playwright", "Postman", "Unit Testing", "Functional Testing", "Black Box", "White Box"]
  }
];
              ...
              <Inview mode="once" from={{ opacity: 0, y: 20 }} to={{ opacity: 1, y: 0 }} delayIn={200}>
                <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-sm flex flex-col gap-4">
                  <p className="text-xs text-white/70 leading-relaxed font-medium">
                    &ldquo;I take client ideas from concept to a live URL &mdash; responsive frontends, robust backend APIs, optimized databases, and thorough testing, all under one roof.&rdquo;
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-2.5 pt-3 border-t border-white/[0.06]">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-[11px] font-bold text-white/90">Code + Data</span>
                    </div>
                  </div>
                </div>
              </Inview>
