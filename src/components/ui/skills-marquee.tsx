              ...
              {row1.map((skill, i) => (
                <React.Fragment key={skill.name + i}>
                  <div className="flex items-center gap-4 px-8">
                    ...
                    <span className={`text-xl md:text-2xl font-black tracking-tighter uppercase ${skill.category === "Frontend" || skill.category === "Databases" ? "text-accent" : "text-foreground"}`}>
                      {skill.name}
                    </span>
                  </div>
              ...
              {row2.map((skill, i) => (
                <React.Fragment key={skill.name + i}>
                  <div className="flex items-center gap-4 px-8">
                    ...
                    <span className={`text-2xl md:text-3xl font-black tracking-tighter uppercase ${skill.category === "Frontend" || skill.category === "Databases" ? "text-accent" : "text-foreground"}`}>
                      {skill.name}
                    </span>
                  </div>
