  ...
  const principles = [
    {
      ...
      description: "Building production web applications end-to-end with Next.js, React, Node.js, and Express — from client websites to full e-commerce platforms.",
    },
    {
      title: "Database Engineering",
      description: "Writing complex queries, stored procedures, and triggers, and optimizing performance through indexing and schema design across SQL, MySQL, PostgreSQL, and MongoDB.",
    },
    {
      title: "Tested & Reliable",
      description: "Validating every feature with black box, white box, unit, and functional testing using Selenium, Playwright, and Postman to ensure data integrity and reliability.",
    },
  ];
