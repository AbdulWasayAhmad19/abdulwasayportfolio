...
// PLACEHOLDER TESTIMONIALS — replace the quotes below with real feedback from
// your clients before enabling this section in src/views/home.tsx.
const testimonials = [
  {
    id: "gondal",
    num: "01",
    name: "Gondal Law Associates",
    role: "Client — Law Firm Website",
    quote: "[Add real client feedback here about the Gondal Law Associates website project.]",
  ...
  },
  {
    ...
    role: "Client — Academy Website",
    quote: "[Add real client feedback here about the Leaders Academy website project.]",
