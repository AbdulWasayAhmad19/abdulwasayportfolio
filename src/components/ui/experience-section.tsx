      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="relative pl-6 md:pl-10 border-l border-white/10 flex flex-col gap-10">
          ...
          {experiences.map((exp, idx) => (
            ...
            >
              {/* Timeline Node Badge */}
              <div className="absolute -left-[31px] md:-left-[47px] top-6 w-5 h-5 rounded-full bg-[var(--raw-color-surface-2)] border-2 border-accent flex items-center justify-center shadow-[0_0_15px_var(--accent)] z-20">
                <div className="w-1.5 h-1.5 rounded-full bg-accent animate-ping" />
              </div>

              {/* Main Glassmorphic Card */}
              <div className="group relative rounded-3xl border border-white/10 bg-[var(--raw-color-surface-2)]/90 hover:border-white/25 transition-all duration-500 overflow-hidden shadow-2xl p-6 sm:p-8 md:p-10 transform-gpu">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          {educationList.map((edu, idx) => (
            <Inview
              ...
              config={{ mass: 1, tension: 280, friction: 24 }}
            >
              <div className="group relative h-full rounded-3xl border border-white/10 bg-[var(--raw-color-surface-2)]/90 hover:border-white/25 transition-all duration-500 overflow-hidden p-6 md:p-8 flex flex-col justify-between gap-6 shadow-xl transform-gpu">
                {/* Top Shine Line */}
